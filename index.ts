...
const DEFAULT_FLASHCARDS: Flashcard[] = [
  ...
  // Beginner Japanese
  { question: "What does こんにちは (konnichiwa) mean?", answer: "Hello / Good afternoon" },
  { question: "What does ありがとう (arigatou) mean?", answer: "Thank you" },
  { question: "What does すみません (sumimasen) mean?", answer: "Excuse me / I'm sorry" },
  { question: "What does はい (hai) mean?", answer: "Yes" },
  { question: "What does いいえ (iie) mean?", answer: "No" },
  { question: "What does おはようございます (ohayou gozaimasu) mean?", answer: "Good morning (polite)" },
  { question: "What does さようなら (sayounara) mean?", answer: "Goodbye" },
  { question: "What does おやすみなさい (oyasuminasai) mean?", answer: "Good night (polite)" },
  { question: "What does いただきます (itadakimasu) mean?", answer: "Thank you for the meal (before eating)" },
  { question: "What does ごちそうさまでした (gochisousama deshita) mean?", answer: "Thank you for the meal (after eating)" },
  { question: "What does だいじょうぶ (daijoubu) mean?", answer: "It's okay / I'm fine" },
  { question: "What does おねがいします (onegaishimasu) mean?", answer: "Please (request)" },
  { question: "What does わかりました (wakarimashita) mean?", answer: "I understand / Understood" },
  { question: "What does 名前 (namae) mean?", answer: "Name" },
  { question: "What does 水 (mizu) mean?", answer: "Water" },
  { question: "What does 食べる (taberu) mean?", answer: "To eat" },
  { question: "What does 飲む (nomu) mean?", answer: "To drink" },
  { question: "What does 大きい (ookii) mean?", answer: "Big" },
  { question: "What does 小さい (chiisai) mean?", answer: "Small" },
  { question: "What does いち (ichi) mean?", answer: "One (1)" },
  { question: "What does に (ni) mean?", answer: "Two (2)" },
  { question: "What does さん (san) mean?", answer: "Three (3)" },
  { question: "What does 猫 (neko) mean?", answer: "Cat" },
  { question: "What does 犬 (inu) mean?", answer: "Dog" },
  { question: "What does 本 (hon) mean?", answer: "Book" },
  { question: "What does 日本 (nihon) mean?", answer: "Japan" },
  { question: "What does 人 (hito) mean?", answer: "Person" },
  { question: "What does 好き (suki) mean?", answer: "Like / Love" },
  { question: "What does 何 (nani) mean?", answer: "What" },
  { question: "What does どこ (doko) mean?", answer: "Where" },
];
...
export default async function (pi: ExtensionAPI) {
  ...
  pi.on("turn_end", async (_event, ctx) => {
    ...
    ctx.ui.setHiddenThinkingLabel(`Thinking... [Q: ${question}  →  A: ${answer}]`);

    // Also log to the chat so the user sees both immediately
    ctx.ui.notify(`Thinking... [Q: ${question}  →  A: ${answer}]`, "info");
  });
}
